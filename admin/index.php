...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Halaman Stok</a>
                        </li>
                    </ul>
                    <?php
                    if (!isset($_SESSION['username'])) {
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="align-middle"><?= $row['jumlahbarang']; ?></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="konfigurasi.php" method="POST" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <label for="judul" class="col-sm-3 col-form-label">Nama Obat</label>
                            <div class="col-sm-9">
                                <input type="text" name="judul" class="form-control" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="deskripsi" class="col-sm-3 col-form-label">Keterengan</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option value="tidak aktif">Tidak Ada</option>
                                </select>
                            </div>
                            <div class="row mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="konfigurasi.php" method="POST" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <label for="judul" class="col-sm-3 col-form-label">Obat</label>
                            <div class="col-sm-9">
                                <input type="text" name="judul" class="form-control" id="judul_u">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="deskripsi" class="col-sm-3 col-form-label">Ketrengan</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row mb-3">
                            ...
                            <label for="jumlahbarang" class="col-sm-3 col-form-label">Jumlah Barang</label>
                            <div class="col-sm-9">
                                <input type="text" name="jumlahbarang" class="form-control" id="jumlahbarang_u">
                            </div>
                        </div>
                        </div>
                </div>
    ...
    <script>
        $(document).on('click', '.update', function(e) {
            ...
            $('#jumlahbarang_u').val(jumlahbarang);
        });
    </script>
    <script>
